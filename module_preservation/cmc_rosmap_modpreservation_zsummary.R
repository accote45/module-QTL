...
Zsummary1 = mp$preservation$Z$ref.CMC$inColumnsAlsoPresentIn.ROSMAP[,"Zsummary.pres"]
Zdensity1 = mp$preservation$Z$ref.CMC$inColumnsAlsoPresentIn.ROSMAP[,"Zdensity.pres"]
Zconnectivity1 = mp$preservation$Z$ref.CMC$inColumnsAlsoPresentIn.ROSMAP[,"Zconnectivity.pres"]
log.p1 = mp$preservation$log.p$ref.CMC$inColumnsAlsoPresentIn.ROSMAP[,"log.psummary.pres"]
p.value1 = exp(log.p1)
moduleSize1=mp$preservation$Z$ref.CMC$inColumnsAlsoPresentIn.ROSMAP$moduleSize
Zsummary.ControlRef.vROSMAP = cbind(Zsummary1, Zdensity1, Zconnectivity1,log.p1, p.value1,moduleSize1)
rownames(Zsummary.ControlRef.vROSMAP) = rownames(mp$preservation$Z$ref.CMC$inColumnsAlsoPresentIn.ROSMAP)
write.table(Zsummary.ControlRef.vROSMAP, file=paste0("Zsummary.ControlRef.vROSMAP.",PathwayName,".txt"), sep="\t",quote=F)
